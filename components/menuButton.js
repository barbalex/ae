...
import searchGoogleImagesOfObject from '../src/searchGoogleImages'
import searchWikipediaArticlesOfObject from '../src/searchWikipediaArticles'
      ...
      <div>
        <div id='menuBtn' className='btn-group menu'>
          <DropdownButton title='Menu' bsSize='small'>
            ...
            <MenuItem><a href='https://twitter.com/arteigenschaft' className='twitter-follow-button' data-lang='de' data-dnt='true'>@arteigenschaft folgen</a></MenuItem>
          </DropdownButton>
        </div>
      </div>
    )
